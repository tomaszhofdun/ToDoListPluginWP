...
function AddTask(props) {
  const [task, setTask] = (0,use_immer__WEBPACK_IMPORTED_MODULE_3__.useImmer)({
    title: "",
    done: "no"
  });
  ...
  const addTask = e => {
    ...
    async function addTaskAjax() {
      try {
        const response = await axios__WEBPACK_IMPORTED_MODULE_1___default().post(toDoData.root_url + "/wp-json/to-do-list/v1/task", {
          title: task.title,
          done: task.done
        }, {
          headers: {
  ...
  }, errors.title), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    style: {
      background: "#198754"
    },
...
function DeleteTask(props) {
  ...
  const handleDelete = id => {
    ...
    async function handleDeleteAjax() {
      try {
        const response = await axios__WEBPACK_IMPORTED_MODULE_1___default().delete(toDoData.root_url + "/wp-json/to-do-list/v1/task", {
          data: {
            id: id
          },
          headers: {
...
function DoneTask(props) {
  ...
  function handleDoneRequest() {
    async function markAsDoneAjax() {
      try {
        const response = await axios__WEBPACK_IMPORTED_MODULE_2___default().put(toDoData.root_url + "/wp-json/to-do-list/v1/task", {
          id: task.id,
          title: task.title,
          done: task.done
        }, {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    ...
    className: "btn btn-success ",
    type: "button"
  }, task.done == "no" ? "Not completed" : "Completed");
}

/* harmony default export */ __webpack_exports__["default"] = (DoneTask);
...
function Edit(props) {
  const [isSave, setIsSave] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const {
    task,
    setTasks,
    tasks,
...
/* harmony import */ var _DoneTask__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DoneTask */ "./src/DoneTask.js");
...
function Task(props) {
  ...
  const [errorDelete, setErrorDelete] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("");
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, errorDelete.length == 0 ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", {
    style: {
      top: "46px"
    },
    className: " position-relative text-danger"
  }, errorDelete) : "", errors.length == 0 ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", {
    style: {
      top: "46px"
    },
    className: " position-relative text-danger"
  }, errors) : "", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("form", {
    onSubmit: handleSave,
    action: ""
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_DoneTask__WEBPACK_IMPORTED_MODULE_5__.default, {
    task: task,
    tasks: tasks,
    setTasks: setTasks,
    setErrors: setErrors
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_EditTask__WEBPACK_IMPORTED_MODULE_4__.default, {
    inputRef: inputRef,
    spanRef: spanRef,
    task: task,
    setTasks: setTasks,
    tasks: tasks
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_DeleteTask__WEBPACK_IMPORTED_MODULE_3__.default, {
...
/* harmony import */ var _styles_style_admin_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./styles/style-admin.scss */ "./src/styles/style-admin.scss");
...
function ToDoApp() {
  ...
  const [countTasks, setCountTasks] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(undefined);
  const [countFinishedTasks, setCountFinishedTasks] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(undefined);
  const [countUnfinishedTasks, setCountUnfinishedTasks] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(undefined);
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    async function getTasksAjax() {
      try {
        const response = await axios__WEBPACK_IMPORTED_MODULE_1___default().get(toDoData.root_url + "/wp-json/to-do-list/v1/tasks", {
          headers: {
            "X-WP-Nonce": toDoData.nonce
          }
        });
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "container"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, "All tasks: ", countTasks), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, "Need to be finished: ", countUnfinishedTasks), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", {
    className: "mb-4"
  }, "Tasks completed: ", countFinishedTasks), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_AddTask__WEBPACK_IMPORTED_MODULE_6__.default, {
    setTasks: setTasks
  }), tasks.map(task => {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Task__WEBPACK_IMPORTED_MODULE_7__.default, {
      setTasks: setTasks,
      tasks: tasks,
      task: task
    });
  }), tasks.length == 0 ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    class: "alert alert-primary mt-3",
    role: "alert"
  }, "You don't have any tasks at this moment. Create one if you want") : "");
}

react_dom__WEBPACK_IMPORTED_MODULE_3___default().render((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(ToDoApp, null), document.getElementById("ToDoListApp"));
